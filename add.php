...
if (isset($_POST['Submit'])) {
    ...
    $add = mysqli_query($koneksi, "INSERT INTO karyawan(id, nama, divisi) VALUES('$id', '$nama', '$divisi')");
...
<div class="bg-success p-2 text-dark bg-opacity-10">
        <h1 class="p-4 text-center">Data Karyawan Baru</h1>
        <div class="container">
                    ...
                    <div class="mb-3">
                        ...
                        <label class="form-label">Nama</label>
                            ...
                            <label class="form-label">Divisi</label>
                             <input type="text" class="form-control" name="divisi" placeholder="Masukkan divisi Karyawan">
                    </div>
                 </div>
